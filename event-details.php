...
<style>
    ...
    <div>
        <div class="">
            ...
            $article=$user->event($_GET["event"]);
            $article=$article->fetch_array();
            ?>
            <div class="banner banner__component--responsive img-parallax">
                <img style="height:620px;" src="photo/event/<?php echo $article["image"]?>" class=" lazy-loaded" style="top: 0px;">
        ...
        <div>
            <div class="container__full content-top clearfix">
                <div class="yCmsContentSlot left-panel">
                  ...
                  <h1 style="color:#0082dd;">Event Details</h1>

                        <div class="content"><h2><?php echo $article["event_title"]?></h2><p><span>Date: &nbsp;<?php echo $article['event_date']?></span></p></div></div><div class="yCmsComponent static-content-block">
                    <div class="content"><p><?php echo strip_tags($article["event_des"]);?></p></div>
        ...
        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'></td>
				...
				;
								...
								echo 'Message could not be sent. Mailer Error: ', $mail->ErrorInfo;
                                       ...
                                       <button style="width:120px;height:42px;border-radius: 5px; " type="submit" name="apply" class="btn btn-default"><span style="text-align:center;">SUBMIT</span></button>
                                       <div>
