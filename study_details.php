...
<?php include("include/header.php")?>
    ...
    <div>
        <div class="">
                 ...
                 $study_details=$user->study_details($_GET["details"]);
                 $study_details=$study_details->fetch_array();
			    ?>
            <div class="banner banner__component--responsive img-parallax">
                <img style="height:620px;" src="photo/<?php echo $study_details["image"]?>" class=" lazy-loaded" style="top: 0px;">
        ...
        <div>
            <div class="container__full content-top clearfix">
                <div class="yCmsContentSlot left-panel">
                  ...
                  <h1 style="color:#0082dd;">About Study Destination</h1>

                        <div class="content"><h2><?php echo $study_details["post_title"]?></h2><p>Study overseas with someone who knows the way</p></div></div><div class="yCmsComponent static-content-block">
                    <div class="content"><p><?php echo $study_details["post_des"]?></p></div></div></div>
