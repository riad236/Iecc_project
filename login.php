                        ...
                        <div class="yCmsComponent login-left-content-component">
                            <div class="login-section">
                                ...
                                <div class="dec_txt">
                                    <div class="headline">
                                        <h2>
                                            <span tabindex="0">Sign in with email</span>
                                        </h2>
                                    </div>
                                    <div class="description">
                                        Already have an account? Sign in to view your personalised page.</div>
                                    <br>
                                </div>
                                <form id="loginForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post"><fieldset>
                                        ...
                                        if(isset($_POST["login"])){
                                            ...
                                            $login=$super_admin->user_login($_POST['email']);
                                            $row=$login->fetch_array();
                                            $sql_pass =$row['password'];
//                                            var_dump($row);
                                            if(password_verify($password,$sql_pass)){
                                                $_SESSION["id"]=$row["id"];
											...
											swal ( "Oops" ,  "Password Input not matched!" ,  "error" )
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="height:20px" id="j_username" name="email" class="input-box form-control" type="text" value=""></div>
                                    <div class="form-group">
                                        <label class="control-label " for="j_password" aria-label="Your password">
                                            Your password</label>
                                        <input style="height:20px" id="j_password" name="pass" class="input-box form-control" type="password" value="" autocomplete="off"></div>
                                    <br>
                                    ...
                                    <div class="forgotten-password">
                                      <a href="forgot" data-link="/bangladesh/login/pw/request" class="js-password-forgotten" data-cbox-title="Password Assistance"> Forgot your password?</a>
                                    </div>
                                </fieldset>
                                    <div>
                    ...
                    <div class="yCmsContentSlot login-right-content-slot">
                        <div class="yCmsComponent login-right-content-component">
                            <div class="register-section">
                                <div class="headline">
                                    <h2 tabindex="0">
                                        New to IECC? Register now with email</h2>
                                </div>
                                <div class="description">
                                ...
                                <form id="IDPRegisterForm" action="" method="post"><fieldset>
                                	<?php
                                		...
                                		if(isset($_POST['sign-up'])){
                                			...
                                			$password = $_POST['pwd'];
                                			$cpwd = $_POST['checkPwd'];
                                			$md5pass = password_hash($password, PASSWORD_DEFAULT);
                                			$email = $_POST['email'];
                                			...
                                			if(empty($fname || $lname || $number || $password || $cpwd || $email)){
                                				echo '<script>


											swal ( "Oops" ,  "Fill The field First!" ,  "error" )
											...
											swal ( "Oops" ,  "Password should be 6 digits long atleast!" ,  "error" )

                                						</script>';

                                			}else{
                                				$sign_up=$user->sign_up($fname,$lname,$number,$email,$md5pass);

                                				if($sign_up){
                                					echo'<script>


											swal ( "Registered Sucessfully" ,  "Welcome To IECC Family" ,  "success" )
                                    ...
                                    <div class="form-group">
                                        <label class="control-label " for="register.lastName" aria-label="Last Name">
                                            Last Name</label>
                                        <input style="height:20px" id="register.lastName" name="lastName" class="input-box form-control" type="text" value=""></div>
                                   
                                  
 										<div class="form-group">
                                        <label class="control-label " for="register.email" aria-label="Your email address">
                                            Your email address</label>
                                        <input style="height:20px" id="register.email" name="email" class="input-box form-control" type="text" value=""></div>

                                    <div class="form-group">
                                        <label class="control-label " for="register.email" aria-label="Your email address">
                                            Your Phone Number</label>
                                        <input style="height:20px" id="register.email" placeholder="Type with country code E.x(+880)" name="number" class="input-box form-control" type="text" value=""></div>
                                    <div class="form-group">
                                        <label class="control-label " for="password" aria-label="Your password">
                                            Your password</label>
                                        <input style="height:20px" id="password" name="pwd" class="input-box form-control password-strength" type="password" value="" autocomplete="off" aria-autocomplete="list"><div id="password_bar" class="progress" style="display: none;"><div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"><span id="password_text">0%<span></span></span></div></div></div><div class="help-block" id="password_minchar">Please enter a password with at least 6 alphanumeric characters in upper and lower case.</div>
                                    <div class="form-group">
                                        <label class="control-label " for="register.checkPwd" aria-label="Confirm your password">
                                            Confirm your password</label>
                                        <input style="height:20px" id="register.checkPwd" name="checkPwd" class="input-box form-control" type="password" value="" autocomplete="off"></div>
