    ...
    <div>
        <div class="">
        	  	 <?php
							...
							$course_post=$user->course_post($_GET["course_post"]);
							$course_post=$course_post->fetch_array();
			    ?>
            <div class="banner banner__component--responsive img-parallax">
                <img style="height:620px;" src="photo/<?php echo $course_post["image"]?>" class=" lazy-loaded" style="top: 0px;">
        ...
        <div>
            <div class="container__full content-top clearfix">
                <div class="yCmsContentSlot left-panel">
                  ...
                  <h1 style="color:#0082dd;">Course Details</h1>

                        <div class="content"><h2><?php echo $course_post["post_title"]?></h2><p>Study overseas with someone who knows the way</p></div></div><div class="yCmsComponent static-content-block">
                    <div class="content"><p><?php echo $course_post["post_des"]?></p></div></div></div>
