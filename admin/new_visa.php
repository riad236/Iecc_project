    ...
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item active" aria-current="page">Visa Service</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
              ...
              <form id="personal-info"action="" method="post"enctype="multipart/form-data">
                  ...
                  if(isset($_POST["save"])){
                    ...
                    if(move_uploaded_file($filetmp,$filepath)){
                      $super_admin->add_visa($title,$dis,$filename);
      ...
      <div class="alert-message">
        <span><strong></strong>Successfully inserted!</span>
                ...
                <div class="form-group row">
                  <label for="input-4" class="col-sm-2 col-form-label"> Title</label>
                  <div class="col-sm-10">
