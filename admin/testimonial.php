    ...
    <!-- End Breadcrumb-->
            ...
            <div class="card-body">
              <form id="personal-info"action="" method="post"enctype="multipart/form-data">
                  ...
                  if(isset($_POST["save"])){
                    ...
                    $filepath = "../photo/testimonial/".$filename;                    
                    if(move_uploaded_file($filetmp,$filepath)){
                      $super_admin->testimonial($_POST["name"],$_POST["ins"],$_POST["edu"],$_POST["country"],$_POST["dis"],$filename);
      ...
      <div class="alert-message">
        <span><strong></strong>Sucessfully inserted!</span>
                ...
                <div class="form-group row">
                  <label for="input-2" class="col-sm-2 col-form-label">Institute</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-2" name="ins" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-3" class="col-sm-2 col-form-label">Educational Qualification</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-3" name="edu" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-4" class="col-sm-2 col-form-label">Country</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-4" name="country" required>
                  </div>
                </div>
                ...
                <i class="fa fa-file-text-o"></i>
                 ...
                 <div class="form-group row">
                  <label for="input-9" class="col-sm-2 col-form-label">Discription</label>
                  <div class="col-sm-10">
