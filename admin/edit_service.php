...
<div class="clearfix"></div>
 ...
 <?php
        if(isset($_GET["edit"])){
        $pedit=$super_admin->edit_service($_GET["edit"]);
            ...
            <div class="card-body">
              <form id="personal-info"action="" method="post"enctype="multipart/form-data">
                  ...
                  if(isset($_POST["save"])){
                    ...
                    $filepath = "../photo/service/".$filename;
                    if(move_uploaded_file($filetmp,$filepath)){
                      $super_admin->update_service($id,$title,$dis,$filename);
      ...
      <div class="alert-message">
        <span><strong></strong>Successfully Updated!</span>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input value="<?php echo $redit['name']?>" type="text" class="form-control" id="input-4" name="title" required>
                  </div>
                </div>
                ...
                <i class="fa fa-file-text-o"></i>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="4" id="input-9" name="dis" required><?php echo $redit['discription']?></textarea>
                  </div>
                </div>
