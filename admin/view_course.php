                ...
                <tbody>
					<?php
											if(isset($_GET["delete"])){
												$delete_country=$super_admin->delete_course($_GET["delete"]);
				...
				<?php $view_course=$super_admin->view_course();
 				...
 				?>
                    ...
                    <tr>
                        ...
                        <td><li><a onclick="return confirm('You are going to delete.are you sure?')" href="view_course?delete=<?php echo $row["id"];?>"title="Delete"><i class="fa fa-trash-o"></i></a></li></td>
                    </tr>
