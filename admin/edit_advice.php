  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Advices</h4>
		    <ol class="breadcrumb">
          ...
          <div class="card">
            <div class="card-body">
                <?php
							...
							if(isset($_GET["edit"])){
							$edit=$super_admin->edit_advice($_GET["edit"]);
              ...
              <form id="personal-info"action="" method="post"enctype="multipart/form-data">
                  ...
                  if(isset($_POST["save"])){
                    ...
                    $filepath = "../photo/advice/".$filename;
                    if(move_uploaded_file($filetmp,$filepath)){
                      $super_admin->update_advice($id,$title,$dis,$filename);
      ...
      <div class="alert-message">
        <span><strong></strong>Successfully Updated!</span>
                ...
                <div class="form-group row">
                  <label for="input-4" class="col-sm-2 col-form-label">Advice Title</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php echo $redit['name']?>" id="input-4" name="title" required>
                  </div>
                </div>
                ...
                <i class="fa fa-file-text-o"></i>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="4" id="input-9" name="dis" required><?php echo $redit['des']?></textarea>
                  </div>
                </div>
