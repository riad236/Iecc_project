...
<?php include("include/header.php")?>
    ...
    <div>
        <div class="">
            ...
            $article=$user->article($_GET["article"]);
        ...
        <div>
            <div class="container__full content-top clearfix">
                <div class="yCmsContentSlot left-panel">
                  ...
                  <h1 style="color:#0082dd;">Blog Post</h1>



                        <div class="content"><h2><?php echo $article["post_title"]?></h2>&nbsp;<p style="font-size: 16px;color:gray;">Posted-By : <?= $article["admin_name"] != "" ? $article["admin_name"] :$article["fname"] ?></p></div>




                    </div><div class="yCmsComponent static-content-block">
                    <div class="content"><p><?php echo $article["post_des"]?></p></div>
                ...
                ?>
                <a class="blog-link" href="login">Login In your IECC account</a>
                ...
                <?php }elseif($_SESSION['id']===$article['user_id']){?>

                <a class="blog-link" href="edit_article?edit=<?php echo $article["post_id"];?>">Edit Your Article </a>&nbsp;


              <?php }elseif($_SESSION['id']!=$article['user_id']){?>

                       <a class="blog-link" href="add_article">Add Your Article</a>
                       ...
                       <?php
						...
						<?php
echo '<iframe src="https://www.facebook.com/plugins/like.php?href='.$actual_link.'&layout=standard&action=like&size=small&show_faces=true&share=true&height=80&appId=2186606351425666" width="450" height="80" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>';
?>

	

<div class="fb-comments" data-href="http://localhost/iecc/article?article=1" data-numposts="5"></div>
                </div>
