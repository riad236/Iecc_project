...
//                                            var_dump($row);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="j_username" name="email" class="input-box form-control" type="text" value=""></div>
                                    <div class="form-group">
                                        <label class="control-label " for="j_password" aria-label="Your password">
                                            Your password</label>
                                        <input id="j_password" name="pass" class="input-box form-control" type="password" value="" autocomplete="off"></div>
                                    <br>
                                    ...
                                    <div class="forgotten-password">
                                        <a href="#" data-link="/bangladesh/login/pw/request" class="js-password-forgotten" data-cbox-title="Password Assistance"> Forgot your password?</a>
                                    </div>
                                </fieldset>
                                    <div>
