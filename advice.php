...
<?php include("include/header.php")?>
    ...
    <div>
        <div class="">
                 ...
                 $view_advice=$user->view_advice($_GET["advice"]);
                 $view_advice=$view_advice->fetch_array();
			    ?>
            <div class="banner banner__component--responsive img-parallax">
                <img style="height:620px;" src="photo/advice/<?php echo $view_advice["image"]?>" class=" lazy-loaded" style="top: 0px;">
        ...
        <div>
            <div class="container__full content-top clearfix">
                <div class="yCmsContentSlot left-panel">
                  ...
                  <h1 style="color:#0082dd;">Advice For You</h1>

                        <div class="content"><h2><?php echo $view_advice["name"]?></h2><p>Study overseas with someone who knows the way</p></div></div><div class="yCmsComponent static-content-block">
                    <div class="content"><p><?php echo $view_advice["des"]?></p></div></div></div>
