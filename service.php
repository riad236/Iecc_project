    ...
    <style>
        ...
        <div class="">
        	  	 <?php
							...
							$service=$user->service($_GET["service"]);
							$service=$service->fetch_array();
			    ?>
            <div class="banner banner__component--responsive img-parallax">
                <img style="height:620px;" src="photo/service/<?php echo $service["image"]?>" class=" lazy-loaded" style="top: 0px;">
        ...
        <div>
            <div class="container__full content-top clearfix">
                <div class="yCmsContentSlot left-panel">
                  ...
                  <h1 style="color:#0082dd;">Service We Provides</h1>

                        <div class="content"><h2><?php echo $service["name"]?></h2><p>Study overseas with someone who knows the way</p></div></div><div class="yCmsComponent static-content-block">
                    <div class="content"><p><?php echo $service["discription"]?></p></div></div></div>
