               ...
               <div class="row">
                  <div class="col-xs-12 no-space">
                     <div class="homepageCarousel">
                        ...
                        <div class="slick-slide">
                           <img class="sl" src="./assets/slider/Slider_img1.png" alt="Want to study in Australia?" >
                                       ...
                                       <li class="col-xs-12 col-sm-3">
                                          <div class="carousel-boxes left-box">
                                             <a class="common-text" target="_blank" href="#">
                                                <div class="col-xs-3 col-sm-12 carousel-image-holder">
                                             ...
                                             <a class="common-text" target="_blank" href="#">
                                                ...
                                                <div class="col-xs-9 col-sm-12">
                                                   ...
                                                   <span class="common-text">
                                                      <p>As international education experts, we can turn your dreams into plan.</p>
                                                   </span>
                                                </div>
                                             </a>
                                          </div>
    ...
    padding-right: 200px;
                        ...
                        <div class="openenq_form">
                           ...
                           <div class="apply-details">
                              <p><span class="text-red">Simply fill in your details here,</span> and one of our education advisors will get in touch.</p>
                           </div>
                                    ...
                                    <ul class="University-list list-container" >
                                       <li class="col-xs-3 col-sm-3">
                                          <div class="left-box landingHovoer">
                                             <a href="<?php echo $row['link']?>" target="_blank"><img style="height:100px;width:230px;" src="photo/partner/<?php echo $row['image']?>" ></a>
                                          </div>
                                       </li>
                                    </ul>
                                 </div>
                  ...
                  <div class="col-xs-12 col-sm-6 landArticle">
                     ...
                     <div class="heroImages-box ng-scope row">
                              ...
                              <div class="home-page">
                                 <div class="row articles-events-section">
                                    <a class="pop_artWrap" target="_blank" href="event-details?event=<?php echo $row ["id"]?>">
                                       ...
                                       <div class="articlesMidRight">
                                          <h3 class="name"><?php echo $row['event_title']?></h3>
                                          <div class="description"><?php echo $string?></div>
                                       </div>
                                    </a>
                                 </div>
                              </div>
                       ...
                       <?php }?>
                        ...
                        <a href="events" class="btn btn-danger text-center"> read more</a>
                     </div>
