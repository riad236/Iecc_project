...
<?php include("include/header.php")?>
    ...
    <div>
        <div class="">
                 ...
                 $view_visa=$user->view_visa($_GET["visa"]);
                 $view_visa=$view_visa->fetch_array();
			    ?>
            <div class="banner banner__component--responsive img-parallax">
                <img style="height:620px;" src="photo/visa/<?php echo $view_visa["image"]?>" class=" lazy-loaded" style="top: 0px;">
        ...
        <div>
            <div class="container__full content-top clearfix">
                <div class="yCmsContentSlot left-panel">
                  ...
                  <h1 style="color:#0082dd;">Others Visa Service</h1>

                        <div class="content"><h2><?php echo $view_visa["name"]?></h2><p>Study overseas with someone who knows the way</p></div></div><div class="yCmsComponent static-content-block">
                    <div class="content"><p><?php echo $view_visa["des"]?></p></div></div></div>
